...
Replace null profiles with snapshots containing actual provider/model, modeId, thinkingOptionId and featureValues, recording verified effective schedule settings. Record branch/base, issue URLs, detailed acceptance and safe test commands where needed in the contract beside state. Permissions shown here require confirmation.
